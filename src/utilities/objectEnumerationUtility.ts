...
export class EnumerateObject {
    ...
    public static SetInstances(
        ...
        let instances: VisualObjectInstance[] = (<VisualObjectInstanceEnumerationObject>instanceEnumeration).instances;
            ...
            case "dataPoint": {
                ...
                for(let i=0;i<model.legendDataPoint.length;i++) {
                    ...
                    let objIns: VisualObjectInstance = {
                        ...
                        selector: (<powerbi.visuals.ISelectionId>legendDataPoint.identity).getSelector(),
                        properties: {
                    ...
                    if (settings.shapes.customizeSeries) {
                        ...
                        if (lineDataPoint!=null) {
                            ...
                            let objIns: VisualObjectInstance = {
                                ...
                                selector: (<powerbi.visuals.ISelectionId>lineDataPoint.identity).getSelector(),
                            };
                            instances.push(objIns);
                        }
